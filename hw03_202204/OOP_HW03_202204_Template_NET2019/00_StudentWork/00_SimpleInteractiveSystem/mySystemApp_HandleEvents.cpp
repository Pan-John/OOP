...
#define cn_StudentInfo "Student Name:Ching-Yang Pan. ID:109700005. Spring 2022"
...
void MY_SYSTEM_APP::update_GraphSystemTitle( )
{
    ...
    title = title + "  " + "Graph System. 2022 Spring.";
...
void MY_SYSTEM_APP::update_2048SystemTitle( const char *msg )
{
    ...
    int numSamples;
    title = cn_StudentInfo;
    title = title + "  " + "2048 System. 2022 Spring.";
    title = title + "   " + msg;
...
void MY_SYSTEM_APP::update_ImageSystemTitle( )
{
    ...
    int numSamples;
    title = cn_StudentInfo;
    title = title + "  " + "Image System. 2022 Spring.";
